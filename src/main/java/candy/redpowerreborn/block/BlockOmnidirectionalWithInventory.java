...
public class BlockOmnidirectionalWithInventory extends BlockContainer
{
    ...
    {
        return new TileEntityOmnidirectionalWithInventory();
    }
    ...
    {
    	return this.getDefaultState().withProperty(FACING, BlockPistonBase.getFacingFromEntity(pos, placer)).withProperty(ON, false);
    }
