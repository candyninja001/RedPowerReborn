...
public class BlockProjectTable extends BlockContainer
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
            	playerIn.openGui(RedPower.instance, GuiHandler.GUI_PROJECTTABLE, worldIn, pos.getX(), pos.getY(), pos.getZ());
               // playerIn.displayGUIChest((TileEntityProjectTable)tileentity);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityProjectTable)
            {
                ((TileEntityProjectTable)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
