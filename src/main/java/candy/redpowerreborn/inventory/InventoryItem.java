...
public class InventoryItem implements IInventory {
	...
	public boolean isItemValidForSlot(int slot, ItemStack itemstack) {
		...
		return !(itemstack.getItem() instanceof ItemCanvasBag);
	}
	...
	public String getName() {
		//TODO make custom names work when the item is renamed
		return "container."+RedPower.MODID+"_canvasbag";
	}
	
	@Override
	public boolean hasCustomName() {
		// TODO is a custom check necessary?
		return false;
	}
	
	@Override
	public ITextComponent getDisplayName() {
		//TODO use code from somewhere other than InventoryCrafting
		return (ITextComponent)(this.hasCustomName() ? new TextComponentString(this.getName()) : new TextComponentTranslation(this.getName(), new Object[0]));
	}
	
	//TODO do these need to be set up?
	@Override
